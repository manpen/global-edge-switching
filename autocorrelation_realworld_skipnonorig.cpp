...
#include <es/autocorrelation/AutocorrelationAnalysisOriginal.hpp>
...
void run_realworld_autocorrelation_analysis(const autocorrelation_config_t& c, std::mt19937_64& gen, const std::string& algolabel, unsigned seed, int pu_id) {
    ...
    AutocorrelationAnalysisOriginal<Algo> aa(c.g,
                                     gen,
                                     c.thinnings,
                                     c.min_snapshots,
                                     algolabel,
...
int main(int argc, char *argv[]) {
    ...
    const autocorrelation_config_t config(g, thinnings, min_snapshots, max_snapshots, input_fn, switches_per_edge, output_fn_prefix);

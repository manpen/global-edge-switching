        ...
        do {
            ...
            #pragma omp parallel reduction(+:successful_switches)
            {
                ...
                for (size_t switch_id = 0; switch_id < num_switches; ++switch_id) {
                    ...
                    edge_dependencies.announce_insert_if_minimum(e3, switch_id);
                ...
                for (size_t switch_id = 0; switch_id < num_switches; ++switch_id) {
                    ...
                    auto check_erase_dependency = [&](auto eid) {
                    ...
                    auto check_insert_dependency = [&](auto eid) {
                    ...
                    auto e3_erase_result = check_erase_dependency(e3);
                    auto e4_erase_result = check_erase_dependency(e4);
                    auto e3_insert_result = check_insert_dependency(e3);
                    auto e4_insert_result = check_insert_dependency(e4);
